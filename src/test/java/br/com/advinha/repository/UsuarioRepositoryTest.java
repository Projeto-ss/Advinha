...
public class UsuarioRepositoryTest {
	...
	public void deveRetornarTresUsuarios() {
		...
		List<Usuario> listaDeUsuarios = usuarioRepository.findAllByNickContainingIgnoreCase("Silva");

		assertEquals(3, listaDeUsuarios.size());
		
		assertTrue(listaDeUsuarios.get(0).getNick().equals("João da Silva"));
		assertTrue(listaDeUsuarios.get(1).getNick().equals("Manuela da Silva"));
		assertTrue(listaDeUsuarios.get(2).getNick().equals("Adriana da Silva"));
