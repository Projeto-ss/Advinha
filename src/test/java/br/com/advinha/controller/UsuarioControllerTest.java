...
import br.com.advinha.repository.UsuarioRepository;
import br.com.advinha.service.UsuarioService;
...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		assertEquals(corpoRequisicao.getBody().getNick(), corpoResposta.getBody().getNick());
